...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x08, 0x69, 0x73, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0x5e, 0x0a, 0x06, 0x52,
	...
	0x6f, 0x6d, 0x2f, 0x47, 0x68, 0x30, 0x35, 0x74, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f,
...
var file_api_v1_log_proto_goTypes = []interface{}{
	...
	(*GetServersRequest)(nil),  // 4: log.v1.GetServersRequest
	(*GetServersResponse)(nil), // 5: log.v1.GetServersResponse
	(*Server)(nil),             // 6: log.v1.Server
...
var file_api_v1_log_proto_depIdxs = []int32{
	...
	6, // 2: log.v1.GetServersResponse.servers:type_name -> log.v1.Server
